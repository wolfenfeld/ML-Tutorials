...
Lets continue to the implementation, where we generate αᵢ randomly, sample it to define the data set and estimate the total population at time _t_ (the horizon): 
