...
After running 500 games and collecting the data the comparison is very straight forward, where the middle line is the mean regret, and the upper and lower bounds are a single standard deviation from the mean.
