...
The comparison is very straight forward, where the middle line is the mean regret, and the upper and lower bounds are a single standard deviation from the mean.

# Conclusion

In this post we have defined the Multi Armed Bandit problem, showed two solutions and compared between them.
